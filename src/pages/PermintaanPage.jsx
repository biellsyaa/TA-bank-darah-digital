...
export default function PermintaanPage() {
    ...
    const [openStatus, setOpenStatus] = useState(null); // id yg dropdown statusnya terbuka
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <div className="px-4 py-4 space-y-3">
                ...
                {filtered.map(item => {
                    // Stok dari JOIN tabel stok_darah
                    ...
                    return (
                        <div key={item.id} className="bg-white rounded-2xl shadow-sm overflow-hidden">
                            ...
                            {/* Card body — data dari 3 tabel (JOIN) */}
                            <div className="px-4 py-3">
                                ...
                                {/* Data pendonor jika ada (JOIN tabel donors) */}
                                {item.donors && (
